...
import com.cts.jpa.pagesort.dto.APIResponse;
import com.cts.jpa.pagesort.entity.Product;
import com.cts.jpa.pagesort.service.ProductService;
...
public class SpringBootPaginationSortingMainApplication {
	@Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringBootPaginationSortingMainApplication.class, args);
	}
